 ...
 * request of these tests touches the realm. The realm still needs its platform keys to start (they are
 * required), hence the same test resource as everywhere else; the app boots once for both test classes.
 * The token verification itself is tested once, in DeskResourceTest.
 */
@QuarkusTest
